  ...
  <div class="country">
    ...
    <div class="card-container">
      <div class="confirmed card">
        ...
        <span class="count">{{ new Intl.NumberFormat({ style: 'unit' }).format(activeCountry.confirmed) }}</span>
      </div>
      <div class="recovered card">
        <h4>Recovered</h4>
        <span class="count">{{ new Intl.NumberFormat({ style: 'unit' }).format(activeCountry.recovered) }}</span>
      </div>

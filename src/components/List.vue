...
export default {
  ...
  computed: {
    ...
    sortedCountries() {
      return this.activeCountries ? Object.values(this.activeCountries).sort((a,b) => {
        return parseInt(b[this.sortMethod], 10) > parseInt(a[this.sortMethod], 10) ? 1 :
                parseInt(b[this.sortMethod], 10) < parseInt(a[this.sortMethod], 10) ? -1 : 0
      }) : ''
    }
  },
  methods: {
